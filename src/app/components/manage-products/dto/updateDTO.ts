export class updateDTO{
  ...
  constructor(product_name: string, description: string, image_path: string, pan_size: string, dimension: string, netweight: string, power_supply: string, status: string, category_name: string) {
